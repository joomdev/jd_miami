													...
													<div class="ns2-tools">
														<?php /*Show Author*/ if ($article_show_author): ?>
															<div class="ns2-author">
																<?php echo '<i class="fa fa-user-circle-o" aria-hidden="true"></i> &nbsp;&nbsp;<span>' . JText::_('MODNS2_WRITTEN') . '</span>' . $list[$i]->author; ?>
															</div>
														<?php endif; ?>
														...
														<?php /*Show date*/ if (($article_date_format) && ($article_date_format!='blog')): ?>
															<div class="ns2-created">
																<?php if ($article_show_author || $article_show_category): ?>
																	&nbsp;&nbsp; <i class="fa fa-clock-o" aria-hidden="true"></i> &nbsp;&nbsp; <span><?php echo JText::_('MODNS2_CREATED') ?></span>
																<?php endif; ?>
